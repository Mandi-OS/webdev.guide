...
const subdomain_name = {'home': 'Главная страница', 'siteWork': 'Работа сайта', 'server': 'Сервер'}
const localScreens = document.querySelectorAll('.localScreen')
const localBtns = document.querySelectorAll('body > header > #nav > *')
...
function setLocalScreen(screenId) {
	screen = document.querySelector(`body > header > #nav #${screenId}`)
